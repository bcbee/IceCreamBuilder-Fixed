...
class MessagesViewController: MSMessagesAppViewController {
    ...
    private func instantiateIceCreamsController() -> UIViewController {
        ...
        //let nav = storyboard?.instantiateViewController(withIdentifier: "ICVC") as? UINavigationController
        //let controller = nav?.viewControllers[0] as! IceCreamsViewController
